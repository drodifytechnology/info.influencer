    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5 fw-bold">{{ __('Edit Category') }}</h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <div class="personal-info">
                    <form action="" method="post" enctype="multipart/form-data"
                        class="add-brand-form pt-0 ajaxform_instant_reload updateCategoryForm">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row">
                            ...
                            <div class="mt-3 col-lg-6">
                                ...
                                <div class="gpt-up-down-arrow position-relative">
                                    <select class="form-control form-selected" name="status" id="category_status">
                            ...
                            <div class="col-lg-2 mt-4 align-self-center">
                                <img id="category_icon" src="" class="table-img">
                            </div>
                        </div>
                        ...
                        <div class="offcanvas-footer mt-3 d-flex justify-content-center">
                            ...
                            <button class="submit-btn btn btn-primary text-white ms-2"
