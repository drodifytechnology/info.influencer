...
@section('main_content')
    ...
    <div class="erp-table-section system-settings">
        <div class="container-fluid">
            <div class="card">
                <div class="card-body">
                    <div class="table-header border-0 pb-0">
                        <h4>{{ __('Payment Gateway Settings') }}</h4>
                    </div>
                </div>
            </div>

            <div class="order-form-section mt-4">
                <div class="row">
                                            ...
                                            <form action="{{ route('admin.gateways.update', $gateway->id) }}" method="post"
                                                ...
                                                <div class="row">
                                                    <div class="col-11 align-self-center mb-2">
                                                        <label class="custom-img-label">{{ __('GATEWAY IMAGE') }}</label>
                                                        <input type="file" name="image" class="form-control">
                                                    </div>

                                                    <div class="col-1 align-self-center mb-2">
                                                        <img src="{{ asset($gateway->image) }}" class="img-fluid"
                                                            alt="">
                                                    </div>
                                                    ...
                                                    <div class="col-12 mb-2">
                                                        ...
                                                        <input type="number" step="any" name="charge"
                                                            value="{{ $gateway->charge }}" class="form-control">
                                                    </div>
                                                    ...
                                                    <div class="col-12 mb-2">
                                                        ...
                                                        <select class="form-control" required name="is_manual">
                                                            <option @selected($gateway->is_manual == 1) value="1">
                                                                {{ __('Yes') }}</option>
                                                            <option @selected($gateway->is_manual == 0) value="0">
                                                                {{ __('No') }}</option>
                                                        </select>
                                                    </div>

                                                    <div class="col-12 mb-2 {{ $gateway->is_manual ? '' : 'd-none' }}">
                                                        <label>{{ __('Accept Image') }}</label>
                                                        <select class="form-control" required name="accept_img">
                                                            <option @selected($gateway->accept_img == 1) value="1">
                                                                {{ __('Yes') }}</option>
                                                            <option @selected($gateway->accept_img == 0) value="0">
                                                                {{ __('No') }}</option>
                                                        </select>
                                                    </div>
                                                            ...
                                                            @foreach ($gateway->manual_data['label'] ?? [] as $key => $row)
                                                                <div class="row row-items">
                                                                    <div class="col-sm-5">
                                                                        ...
                                                                        <input type="text" name="manual_data[label][]"
                                                                            value="{{ $row }}"
                                                                    ...
                                                                    <div class="col-sm-5">
                                                                        <label
                                                                            for="">{{ __('Select Required/Optional') }}</label>
                                                                        <select class="form-control" required
                                                                            name="manual_data[is_required][]">
                                                                            <option @selected($gateway->manual_data['is_required'][$key] == 1)
                                                                                value="1">{{ __('Required') }}
                                                                            </option>
                                                                            <option @selected($gateway->manual_data['is_required'][$key] == 0)
                                                                                value="0">{{ __('Optional') }}
                                                                            </option>
                                                                        </select>
                                                                    </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-12 mt-2">
                                                                <a href="javascript:void(0)"
                                                                    class="fw-bold text-primary add-new-item"><i
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="button-group text-center mt-4">
                                                            <button class="theme-btn m-2 submit-btn"><i
