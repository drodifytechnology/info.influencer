<div class="modal fade" id="influencer-send-email-modal">
    <div class="modal-dialog modal-dialog-centered modal-md">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5">{{ __('Send email to influencer') }}</h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <div class="personal-info">
                    <form action="" method="post" enctype="multipart/form-data"
                        class="add-brand-form pt-0 ajaxform_instant_reload influencerSendEmailForm">
                        @csrf
                        <div class="row">
                            <div class="mt-3">
                                <label class="custom-top-label">{{ __('Mail To') }}</label>
                               <input type="email" id="influencer_email" name="email" rows="2" class="form-control" placeholder="{{ __('Enter email') }}">
                            </div>
                            <div class="mt-3">
