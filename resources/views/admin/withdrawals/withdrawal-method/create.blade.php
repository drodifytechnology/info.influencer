            ...
            <div class="cards">
                <div class="card-body">
                    ...
                    <div class="order-form-section p-16">
                        {{-- form start --}}
                        <form action="{{ route('admin.withdraw_methods.store') }}" method="post"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mt-2">
                                        ...
                                        <div class="input-group">
                                            <input type="number" name="charge" class="form-control border-0 bg-transparent" placeholder="{{ __('EX:Enter Amount') }}" aria-label="" aria-describedby="basic-addon2">
                                    ...
                                    <div class="col-lg-6 mt-2">
                                        ...
                                        <input type="text" name="instructions" class="form-control"
                                            placeholder="{{ __('Enter Instructions') }}">
                                    </div>
                                    ...
                                    <div class="col-12 mb-2">
                                        <div class="manual-rows" id="dynamic-input-fields">
                                            <div class="row row-items">
                                                <div class="col-sm-6">
                                                    ...
                                                    <input type="text" name="meta[label][]" class="form-control" required
                                        ...
                                        <div class="row">
                                            <div class="col-12 mt-2">
                                                <a href="javascript:void(0)" class="fw-bold text-primary add-new-item"><i class="fas fa-plus-circle"></i>{{ __('Add new row') }}</a>
                                            </div>
                                        </div>
                                    </div>
